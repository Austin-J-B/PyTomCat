...
PROFILE_UPDATE_EDIT_DELAY_SEC=1.5     # Delay between profile message edits to avoid Discord 429s
VISION_FEEDBACK_SHEET_BACKOFF_SEC=21600 # Pause Discord feedback sheet sync after capacity errors
